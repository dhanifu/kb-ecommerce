...
<head>
    ...
    <style>
        ...
        .rtl {
            direction: rtl;
            font-family: Tahoma, 'Helvetica Neue', 'Helvetica', Helvetia, Arial, sans-serif;
        }
            ...
            <tr class="top">
                <td colspan="2">
                    <table>
                        <tr>
                            <td class="title">
                                <img src="{{ asset('ecommerce/img/gabutspeople-logo-tp.png') }}" width="150px">
                            </td>
                            <td>
